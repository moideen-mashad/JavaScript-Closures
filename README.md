...
```mermaid
graph TD
    subgraph Setup ["Part 1: The Setup"]
        direction LR
    ...
    subgraph Execution ["Part 2: Persistent Access"]
        direction LR
        ScopeRef[["Closure Scope"]] --> Call1["myCounterA()"]
        Call1 --> Res1("Count: 1")
    ...
    style ScopeRef fill:#fff3e0,stroke:#e65100,stroke-width:3px
